...
struct ConfigContainer {
    ...
    {
        return *media_ifs[static_cast<size_t>(iface_ifx)].proto_info[static_cast<size_t>(proto_idx)];
    }
    MEDIA_interface &getMediaIfaceInfo(int iface_ifx) { return media_ifs[static_cast<size_t>(iface_ifx)]; }
