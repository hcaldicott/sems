...
enum address_type { IPnone = 0, IPv4 = 1, IPv6 = 2 };

enum proto_type { TCP = 1, UDP = 2 };

enum dns_priority { IPv4_only, IPv6_only, Dualstack, IPv4_pref, IPv6_pref };
...
class dns_entry : public atomic_ref_cnt, public dns_base_entry {
  ...
  public:
    ...
    virtual dns_entry *resolve_alias(dns_cache &cache, const dns_priority priority, dns_rr_type rr_type)
    {
        return nullptr;
    }
...
class _resolver : public AmThread {
  public:
    // disable SRV lookups
