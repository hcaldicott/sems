...
class AmStunConnection : public AmStreamConnection {
  public:
    enum PairState { PAIR_FROZEN = 0, PAIR_WAITING, PAIR_IN_PROGRESS, PAIR_RETRANSMIT, PAIR_FAILED, PAIR_SUCCEEDED };
  ...
  public:
    ...
    void set_credentials(const string &luser, const string &lpassword, const string &ruser, const string &rpassword);
    ...
    { /*symmetric rtp is disabled for ice*/ }
