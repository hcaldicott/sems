...
enum PlayoutType { ADAPTIVE_PLAYOUT, JB_PLAYOUT, SIMPLE_PLAYOUT };
...
class AmRtpAudio : public AmRtpStream, public AmAudio, public AmPLCBuffer {
  ...
  public:
    ...
    void record(unsigned long long system_ts, unsigned char *buffer, int input_sample_rate, unsigned int size);
